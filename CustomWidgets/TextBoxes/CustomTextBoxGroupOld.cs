...
namespace CustomLibrary.TextBoxes {
    ...
    public class CustomTextBoxGroupOld: UserControl {
        ...
        public CustomTextBoxGroupOld(string? textName, Color borderColorError) : base() {
            Margin = new(0);
        ...
        private void ResizeChildren(object? sender, EventArgs eventArgs) {
            System.Console.WriteLine($"{_textName}.Height: " + Height);
            // Calculate font
