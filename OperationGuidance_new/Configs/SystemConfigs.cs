                ...
                {Key_Is_User_Info_panel, false},
                {
                    Key_Children, new List<Dictionary<string, object?>>() {
                        ...
                        new() {
                            {Key_ID, 502},
                            {Key_Name, "站点配置"},
                            {Key_Icon, Properties.Resources.work_station},
                            {Key_Toggle_Button, true},
                            {Key_Click, null},
                        ...
                        new() {
                            {Key_ID, 503},
                            {Key_Name, "设备管理"},
                            {Key_Icon, Properties.Resources.device_management},
                            {Key_Toggle_Button, true},
                            {Key_Click, null},
                        ...
                        new() {
                            {Key_ID, 504},
                            {Key_Name, "设备型号管理"},
                            {Key_Icon, Properties.Resources.device_model},
                            {Key_Toggle_Button, true},
                            {Key_Click, null},
                        ...
                        new() {
                            {Key_ID, 505},
                            {Key_Name, "设备类型管理"},
                            {Key_Icon, Properties.Resources.device_category},
                            {Key_Toggle_Button, true},
                            {Key_Click, null},
                        ...
                        new() {
                            {Key_ID, 506},
                            {Key_Name, "品牌管理"},
                            {Key_Icon, Properties.Resources.brand_management},
                            {Key_Toggle_Button, true},
                            {Key_Click, null},
