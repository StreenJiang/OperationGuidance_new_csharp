...
namespace OperationGuidance_service.Utils {
    ...
    public class IniFileUtil {
        ...
        private string _fileName = "DatabaseConfigs";
        #endregion 
        ...
        #region Constructors
        public IniFileUtil(string? IniPath = null) => _path = new FileInfo(IniPath ?? CommonUtils.GetBaseDirectory() + _fileName + ".ini").FullName;
        #endregion
