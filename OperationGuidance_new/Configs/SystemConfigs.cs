                ...
                {Key_View_Name, typeof(CustomTabPanel)},
                {
                    Key_Children, new List<Dictionary<string, object?>>() {
                        ...
                        new() {
                            {Key_ID, 502},
                            {Key_Name, "站点配置"},
                            {Key_Icon, Properties.Resources.station_settings},
                            {Key_Toggle_Button, true},
                            {Key_Click, null},
                            {Key_View_Name, typeof(StationSettingsView)},
                        },
                        new() {
                            {Key_ID, 503},
                            {Key_Name, "通讯设备"},
                            {Key_Icon, Properties.Resources.communication_device},
                            {Key_Toggle_Button, true},
                            {Key_Click, null},
                            {Key_View_Name, typeof(CommunicationDeviceView)},
                        },
                        new() {
                            {Key_ID, 504},
                            {Key_Name, "串口设备"},
                            {Key_Icon, Properties.Resources.serial_port_device},
                            {Key_Toggle_Button, true},
                            {Key_Click, null},
                            {Key_View_Name, typeof(SerialPortDeviceView)},
                        },
                        new() {
                            {Key_ID, 505},
                            {Key_Name, "存储参数"},
                            {Key_Icon, Properties.Resources.store_variables},
                            {Key_Toggle_Button, true},
                            {Key_Click, null},
                            {Key_View_Name, typeof(StoreVariablesView)},
                        },
                        new() {
                            {Key_ID, 506},
                            {Key_Name, "开发者选项"},
