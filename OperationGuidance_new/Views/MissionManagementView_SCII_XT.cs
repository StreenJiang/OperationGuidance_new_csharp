...
namespace OperationGuidance_new.Views {
    public class MissionManagementView_SCII_XT: CustomContentPanel {
        ...
        private MissionEditionView_SCII_XT? _editionView;

        public MissionEditionView_SCII_XT EditionView {
            get {
                if (_editionView == null) {
                    _editionView = WidgetUtils.GetView<MissionEditionView_SCII_XT>();
                }
                return _editionView;
            }
        }

        public MissionManagementView_SCII_XT() : base() {
            // Get apis
