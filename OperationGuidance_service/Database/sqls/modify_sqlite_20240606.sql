ALTER TABLE "product_bolt" RENAME TO "_product_bolt_old_20240606";
...
INSERT INTO "sqlite_sequence" (name, seq) VALUES ('product_bolt', '3');

INSERT INTO "product_bolt" ("id", "side_id", "serial_num", "name", "arranger_id", "specification", "workstation_id", "position", "location_x_percent", "location_y_percent", "setter_selector_id", "bit_specification", "parameters_set", "torque_min", "torque_max", "angle_min", "angle_max", "enabled", "user_id", "deleted", "creator", "modifier", "create_time", "modify_time") SELECT "id", "side_id", "serial_num", "name", "arranger_id", "specification", "workstation_id", "position", "location_x_percent", "location_y_percent", "setter_selector_id", "bit_specification", "parameters_set", "torque_min", "torque_max", "angle_min", "angle_max", "enabled", "user_id", "deleted", "creator", "modifier", "create_time", "modify_time" FROM "_product_bolt_old_20240606";

DROP TABLE "_product_bolt_old_20240606";
